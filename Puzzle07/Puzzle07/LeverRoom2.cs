...
namespace Puzzle07
{
    class LeverRoom2:Room
    {
        ...
        public LeverRoom2(KeyboardState kState, Player plyer, Rectangle leverPos1, Rectangle leverPos2, Texture2D tex1, Texture2D tex2): base(kState, plyer)
        {
            ...
            lever3 = new Lever(200, 100, 64, 64);
            lever4 = new Lever(600, 800, 64, 64);
            lever5 = new Lever(400, 400, 64, 64);
            lever6 = new Lever(350, 700, 64, 64);
            lever1.OnOff = false;
            lever2.OnOff = false;
            lever3.OnOff = false;
            lever4.OnOff = false;
